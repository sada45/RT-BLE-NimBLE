...
#if RTBLE || BLEX
	cc_params->conn_itvl_ticks = cc_params->conn_itvl * 41;
	cc_params->conn_itvl_usecs = 0;
#else
    ble_ll_conn_itvl_to_ticks(cc_params->conn_itvl, &cc_params->conn_itvl_ticks,
                              &cc_params->conn_itvl_usecs);
#endif
//	rtt_printf("cc params itvl ticks");
//	rtt_print_uint32(cc_params->conn_itvl_ticks);
//	rtt_printf("\n");
    return 0;
}
...
#if RTBLE || BLEX
    cc_params.offset = le16toh(cmd->offset);
#endif
